...
export const Navbar = () => {
    ...
    return (
        <div className="z-50 fixed flex justify-center w-full text-white font-bold">
            <div
                className="border-white/20 mt-8 backdrop-blur-3xl rounded-3xl hidden md:flex items-center justify-center p-2 max-w-[400px] mx-auto">
            ...
            <div 
                onClick={toggleNav}
                className="md:hidden absolute top-5 right-14 border rounder z-50 text-white/70 border-white/70 p-2">
